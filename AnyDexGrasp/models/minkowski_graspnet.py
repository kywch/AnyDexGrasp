...
# This is the "grasp-centric representation" model:
# depth map --> two-finger grasp points and geometry info
...
# This is the stage 2, grasp decision model
class MultifingerGraspSuccessPredictor(nn.Module):
    def __init__(
        self,
        input_num=480,
        ...
        output_dim = num_multifinger_depth * num_multifinger_type * num_two_finger_angle * num_two_finger_depth
    ...
    def forward(self, grasp_preds_features):
        grasp_features_five_finger = grasp_preds_features.unsqueeze(-1)
...
# NOTE: This is to enable pickle.load() of the pre-trained weights
class MinkowskiGraspNetMultifingerType1(MultifingerGraspSuccessPredictor):
    pass
