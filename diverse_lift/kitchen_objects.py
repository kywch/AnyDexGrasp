# Original script: https://github.com/robocasa/robocasa/blob/main/robocasa/models/objects/kitchen_objects.py

# Constant that contains information about each object category.
# These will be used to generate the ObjCat classes for each category
OBJ_CATEGORIES = dict(
    liquor=dict(
        types=("drink", "alcohol"),
        graspable=True,
